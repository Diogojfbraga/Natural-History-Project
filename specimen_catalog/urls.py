...
from . import views
from .views import (IndexView, AllSpecimensView, SpecimenDetailView, 
                    ExpeditionUpdateView, TaxonomyUpdateView, 
                    SpecimenDeleteView, NewSpecimenView, 
                    NewTaxonomyView, NewExpeditionView,
                    )
